<template>
    ...
    <div class="bg-slate-700 rounded-xl p-4 shadow-lg">
        <h2 class="text-xl font-bold text-slate-300 mb-4">Added Courses</h2>
        <div v-if="courses.length === 0" class="text-slate-400 text-center py-8">
        ...
        >
            ...
            <span class="font-bold">{{ course.day }}</span>: {{ course.title }} ({{ course.code }})
            </span>
    ...
    <div class="bg-slate-700 rounded-xl p-4 shadow-lg md:col-span-2">
        <h2 class="text-xl font-bold text-slate-300 mb-4">{{ editingIndex === -1 ? 'Add New Course' : 'Edit Course' }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex flex-col">
            <label for="day" class="text-sm font-medium text-slate-300 mb-1">Day</label>
            <select
            id="day"
        ...
        <div class="flex flex-col">
            <label for="start" class="text-sm font-medium text-slate-300 mb-1">Start Time</label>
            <select
            id="start"
        ...
        <div class="flex flex-col">
            <label for="end" class="text-sm font-medium text-slate-300 mb-1">End Time</label>
            <select
            id="end"
        ...
        <div class="flex flex-col">
            <label for="code" class="text-sm font-medium text-slate-300 mb-1">Course Code</label>
            <input
            id="code"
        ...
        <div class="flex flex-col md:col-span-2">
            <label for="title" class="text-sm font-medium text-slate-300 mb-1">Course Title</label>
            <input
            id="title"
        ...
        <div class="flex flex-col">
            <label for="room" class="text-sm font-medium text-slate-300 mb-1">Room</label>
            <input
            id="room"
        ...
        <div class="flex flex-col">
            <label for="type" class="text-sm font-medium text-slate-300 mb-1">Type</label>
            <select
            id="type"
        ...
        <div class="flex flex-col">
            <label for="section" class="text-sm font-medium text-slate-300 mb-1">Section</label>
            <input
            id="section"
...
const addCourse = () => {
  const { day, start, end, code, title, room, type, section } = newCourse.value;
